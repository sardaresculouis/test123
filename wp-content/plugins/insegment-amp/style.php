...
* AMP Framework Reset
*****/
body{ font-family: 'Lato', sans-serif; font-size: 16px; line-height:1.4; }
...
<?php if($redux_builder_amp['minimalblog-color-scheme']['rgba']){?>
    ...
    <?php } else { ?> color: #21a95e; <?php } ?>text-decoration: none }
      a, a:active, a:visited {color: #21a95e;}
...
* Font Family
*****/
@font-face{font-family:'Lato';font-style:normal;font-weight:900;src:local('Lato-Black'),local('Lato-Black'),url('<?php echo plugin_dir_url(__FILE__) ?>fonts/Lato-Black.ttf')}
@font-face{font-family:'Lato';font-style:italic;font-weight:700;src:local('Lato-Bold'),local('Lato-Bold'),url('<?php echo plugin_dir_url(__FILE__) ?>fonts/Lato-Bold.ttf')}
@font-face{font-family:'Lato';font-style:normal;font-weight:400;src:local('Lato-Regular'),local('Lato-Regular'),url('<?php echo plugin_dir_url(__FILE__) ?>fonts/Lato-Regular.ttf')}
...
.header .hero-title-wrapper {
  padding: 0 15px;
}
.header .hero-title-wrapper .hero-title {
  color: #fff;
  font-size: 50px;
  line-height: 56px;
  font-weight: 900;
...
* Footer
*****/
.footer{margin:0;font-size:16px;border-top: 2px solid #21a95e;display:inline-block;clear:both;width:100%;padding: 20px 15px;box-sizing: border-box;}
...
.single .feat-img{width:100%;overflow:hidden;max-height:100vh;}
...
.loop-pagination .right a:after{content:">"; margin-left: 5px;}
.loop-pagination .left a:before{content:"<"; margin-right: 5px;}
...
.single .image-container {float: none; margin: 0 auto;}
...
.rlp-cnt{text-align:center}
.related_link{font-size:16px;line-height:30px;margin-bottom: 10px;}
.related_link a{color:#636363;}
...
.single-cntn ul li{position:relative;margin-bottom:12px}
...
.social-links-wrap .join-us-text {
  color: #636363;
  font-size: 22px;
  margin-right: 10px;
}
...
.loop-wrapper .author-date-wrap {
 ...
 .author-date-wrap .post-author-name {
  float: left;
}
 .author-date-wrap .amp-author {
  display: inline-block;
  color: #21a95e;
}
 .author-date-wrap .post-date {
  float: right;
}
...
.loop-wrapper .read-more-button {
  text-align: center;
  margin-bottom: 50px;
  margin-top: 20px;
}
.loop-wrapper .read-more-button a {
  border: 2px solid #21a95e;
  padding: 6px;
  display: inline-block;
}
.single .author-date-wrap {
  font-size: 12px;
  padding: 0 15px;
  display: inline-block;
  width: 100%;
...
@media (min-width: 767px) {
  ...
  .image-container, .col-right-wrap {
    width: 49%;
    float: left;
    box-sizing: border-box;
  }
  ...
  .loop-wrapper .loop-title, .loop-category, .loop-wrapper .read-more-button, .loop-wrapper .loop-container p {
    text-align: left;
  }
}
.loop-container a {
...
div.categories-navigation ul li {
    list-style: none;
    padding: 5px 10px;
    display: inline-block;
}

div.categories-navigation .categories-container:focus li.category-item {
    display:block;
}
...
#header-sidebar[aria-hidden="false"] .ampstart-navbar-trigger {
  border-radius: 3px;
  background-color: #21a95e;
  opacity: 1;
  font-size: 30px;
  line-height: 29.6px;
  float: right;
...
.ampstart-sidebar .ampstart-nav-item.ampstart-nav-dropdown section header {
  position: relative;
}
.ampstart-sidebar .ampstart-nav-item.ampstart-nav-dropdown section header:focus {
  outline: none;
}
.ampstart-sidebar .ampstart-nav-item.ampstart-nav-dropdown section header:after {
  content: '+';
  top: 0;
  right: 20px;
  position: absolute;
}
.ampstart-sidebar .ampstart-nav-item.ampstart-nav-dropdown section[expanded] header:after {
  content: '-';
}
.ampstart-sidebar .ampstart-nav-item.ampstart-nav-dropdown section[expanded] > ul.ampstart-dropdown-items {
  padding-left: 20px;
}
.ampstart-sidebar .ampstart-nav-item.ampstart-nav-dropdown section[expanded] > ul.ampstart-dropdown-items a {
  font-size: 24px;
  font-weight: 300;
  padding: 10px 0;
  display: block;
...
.ampstart-dropdown-item, .ampstart-nav-item a {
  line-height: 30px;
  display: inline-block;
  width: 100%;
}
.ampstart-dropdown section header, .ampstart-nav-item {
  line-height: 30px;
  font-size: 30px;
  font-weight: 300;
